...
{
    public partial class AddRetrnGPToDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReturnableGPId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ...
                    OtherLocation = table.Column<int>(type: "int", nullable: false),
                    ToDept = table.Column<int>(type: "int", nullable: false),
                    RepairName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RepairContNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VehicleNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DrHelname = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Remarks = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReturnPlace = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReturnableGP", x => x.ReturnableGPId);
                    table.ForeignKey(
                        name: "FK_ReturnableGP_Department_DepId",
                        column: x => x.DepId,
                        principalTable: "Department",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_ReturnableGP_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReturnableGP_DepId",
                table: "ReturnableGP",
                column: "DepId");

            migrationBuilder.CreateIndex(
                name: "IX_ReturnableGP_UserId",
                table: "ReturnableGP",
                column: "UserId");
        }
