...
namespace GatePassManagementSystem.Pages.Reports
{
    public class SinthawaReportModel : PageModel
    {
        ...
        public async Task OnGet()
        {
            ...
            PersonalGPs = await _db.PersonalGP.Where(gp => gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.ChkSinthawatta == true).ToListAsync();
            WorkerGPs = await _db.WorkerGP.Where(gp => gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.ChkSinthawatta == true).ToListAsync();
        ...
        public IActionResult OnGetGenerateExcel()
        {
            ...
            PersonalGPs = _db.PersonalGP
                .Where(gp => gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.ChkSinthawatta == true)
                .ToList();
        ...
        public IActionResult GenerateExcel(List<Model.PersonalGP> personalGPs)
        {
            ...
            {
                var worksheet = workbook.Worksheets.Add("SinthawattaReportStaff");
                ...
                worksheet.Cell(1, 6).Value = "Sinthawatta In Time";
                worksheet.Cell(1, 6).Value = "Sinthawatta Out Time";
                worksheet.Cell(1, 6).Value = "In Time";
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "SinthawattaReportStaff.xlsx");
            }
        ...
        public IActionResult GenerateExcelcsv(List<Model.PersonalGP> personalGPs)
        {
            using (var workbook = new XLWorkbook())
            {
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "SinthawattaReportStaff.csv");
            }
        ...
        public IActionResult GenerateExcelworker(List<WorkerGP> workerGPs)
        {
            using (var workbook = new XLWorkbook())
            {
                var worksheet = workbook.Worksheets.Add("SinthawattaReportWorkers");
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "SinthawattaReportWorkers.xlsx");
            }
        ...
        public IActionResult GenerateExcelcsvworker(List<WorkerGP> workerGPs)
        {
            using (var workbook = new XLWorkbook())
            {
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "SinthawattaReportWorkers.csv");
            }
