...
namespace GatePassManagementSystem.Pages.Reports
{
    public class MadupitiyaReportsModel : PageModel
    {
        ...
        public async Task OnGet()
        {
            ...
            PersonalGPs = await _db.PersonalGP.Where(gp => gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.ChkMadu == true).ToListAsync();
            WorkerGPs = await _db.WorkerGP.Where(gp => gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.ChkMadu == true).ToListAsync();
        ...
        public IActionResult OnGetGenerateExcel()
        {
            ...
            PersonalGPs = _db.PersonalGP
                .Where(gp => gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.ChkMadu == true)
                .ToList();
