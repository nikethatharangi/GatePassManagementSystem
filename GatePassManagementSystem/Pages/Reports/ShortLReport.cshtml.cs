...
namespace GatePassManagementSystem.Pages.Reports
{
    public class ShortLReportModel : PageModel
    {
        ...
        public async Task OnGet()
        {
            ...
            PersonalGPs = await _db.PersonalGP.Where(gp => gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.ChkShrt == true).ToListAsync();
            WorkerGPs = await _db.WorkerGP.Where(gp => gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.ChkShrt == true).ToListAsync();
        }
        ...
        public IActionResult OnGetGenerateExcel()
        {
            ...
            PersonalGPs = _db.PersonalGP
                .Where(gp => gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.ChkShrt == true)
                .ToList();
        ...
        public IActionResult GenerateExcel(List<Model.PersonalGP> personalGPs)
        {
            ...
            {
                var worksheet = workbook.Worksheets.Add("ShortLeaveReportStaff");
                ...
                foreach (var personalGP in personalGPs)
                {
                    ...
                    worksheet.Cell(row, 5).Value = personalGP.Reason;
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "ShortLeaveReportStaff.xlsx");
            }
        ...
        public IActionResult GenerateExcelcsv(List<Model.PersonalGP> personalGPs)
        {
            using (var workbook = new XLWorkbook())
            {
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "ShortLeaveReportStaff.csv");
            }
        ...
        public IActionResult GenerateExcelworker(List<WorkerGP> workerGPs)
        {
            using (var workbook = new XLWorkbook())
            {
                var worksheet = workbook.Worksheets.Add("ShortLeaveReportWorkers");
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "ShortLeaveReportWorkers.xlsx");
            }
        ...
        public IActionResult GenerateExcelcsvworker(List<WorkerGP> workerGPs)
        {
            using (var workbook = new XLWorkbook())
            {
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "ShortLeaveReportWorkers.csv");
            }
