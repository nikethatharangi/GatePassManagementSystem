...
namespace GatePassManagementSystem.Pages.ReturnableGP
{
    public class CreateRGPModel : PageModel
    {
        ...
        [BindProperty]
        public Model.ReturnableGP ReturnableGP { get; set; }
        public Department Department { get; set; }
      
        public IEnumerable<Model.ReturnableGP> ReturnableGPs { get; set; }
        public List<ReturnItemDsc> ReturnItemDscsl { get; set; }
        ...
        public void GetId()
        {
            try
            {
                ...
                var result = _db.ReturnableGP.OrderBy(gp => gp.ReturnableGPId).Select(gp => gp.ReturnableGPId).LastOrDefault();
                if (result == null)
                {
                    GPId = "RP000001";
                }
        ...
        public ActionResult EmailSendToHodApprover(Model.ReturnableGP returnableGP)
        {
            ...
            bool depheadUn = _db.ReturnableGP.Where(u => u.Id == currentUserId).Select(u => u.ChkifDeptHeadUn).FirstOrDefault();
            ...
            return RedirectToPage("CreateRGP");
        }


        public ActionResult EmailSendToMangApprover(Model.ReturnableGP returnableGP)
        {
            currentUserId = Convert.ToInt32(HttpContext.Session.GetString("UserId"));
            deptId = Convert.ToInt32(HttpContext.Session.GetString("DepartId"));
            ChngAprl = _db.ReturnableGP.Where(u => u.ReturnableGPId == ReturnableGP.ReturnableGPId).Select(u => u.ChApprvlId).FirstOrDefault();
            ...
            if (ChngAprl == 0)
            {
                if (deptId == 8 || deptId == 9) //mr. Ruwan
                {
                    ...
                    message.Body = "Dear Mr.Ruwan," + "<br />You recieved a new Good Gate Pass Request" + " from :" + "<b>" + ReturnableGP.CreateUser + "</b>" + "<br />" + "Thank you.";
                    client.Send(message);
                }
                else if (deptId == 10) //mr. Sugath
                {
                    ...
                    message.Body = "Dear Mr.Sugath," + "<br />You recieved a new Good Gate Pass Request" + " from :" + "<b>" + ReturnableGP.CreateUser + "</b>" + "<br />" + "Thank you.";
                }
                else if (deptId == 12) //mr. Geethanga
                {
                    //To list
                    message.To.Add("managerhr@westernpapersl.com");
                    message.Body = "Dear Mr.Geethanga," + "<br />You recieved a new Good Gate Pass Request" + " from :" + "<b>" + ReturnableGP.CreateUser + "</b>" + "<br />" + "Thank you.";
                }
                else if (deptId == 19) //mr. Wijekoon
                {
                    //To list
                    message.To.Add("em@westernpapersl.com");
                    message.Body = "Dear Mr.Wijekoon," + "<br />You recieved a new Good Gate Pass Request" + " from :" + "<b>" + ReturnableGP.CreateUser + "</b>" + "<br />" + "Thank you.";
                }
                else if (deptId == 22) // mrs. kumudu
                {
                    //To list
                    message.To.Add("managerr&d@westernpapersl.com");
                    message.Body = "Dear Mr.Kumudu," + "<br />You recieved a new Good Gate Pass Request" + " from :" + "<b>" + ReturnableGP.CreateUser + "</b>" + "<br />" + "Thank you.";
                }
                else if (deptId == 15 || deptId == 20) // mr. Rohan
                {
                    //To list
                    message.To.Add("chaminda@wesrernpapersl.com");
                    message.Body = "Dear Mr.Rohan," + "<br />You recieved a new Good Gate Pass Request" + " from :" + "<b>" + ReturnableGP.CreateUser + "</b>" + "<br />" + "Thank you.";
                }
            ...
            else if (ChngAprl == 6) //mr. dharampriya
            {
                ...
                message.Body = "Dear Mr.Dharmapriya," + "<br />You recieved a new Good Gate Pass Request" + " from :" + "<b>" + ReturnableGP.CreateUser + "</b>" + "<br />" + "Thank you.";
            }
            else if (ChngAprl == 7) // mr. thusitha
            {
                //To list
                message.To.Add("ceo@westernpapersl.com");
                message.Body = "Dear Mr.Thusitha," + "<br />You recieved a new Good Gate Pass Request" + " from :" + "<b>" + ReturnableGP.CreateUser + "</b>" + "<br />" + "Thank you.";
            }
            ...
            else if (ChngAprl == 26) //mr.damith
            {
                ...
                message.Body = "Dear Mr.Damith," + "<br />You recieved a new Good Gate Pass Request" + " from :" + "<b>" + ReturnableGP.CreateUser + "</b>" + "<br />" + "Thank you.";
            }
        ...
        public ActionResult EmailSend(Model.ReturnableGP returnableGP)
        {
            currentUserId = Convert.ToInt32(HttpContext.Session.GetString("UserId"));
            string userEmail = _db.User.Where(u => u.Id == currentUserId).Select(u => u.Email).FirstOrDefault();
            string fullname = _db.User.Where(u => u.Id == currentUserId).Select(u => u.FullName).FirstOrDefault();
            ...
            else
            {
                ...
                message.Body = "Hello " + fullname + "," + "<br /><h4>You have successfully created a Good Gate Pass !!</h4><br />" + "Your Good Gate pass ID :" + "<b>" + ReturnableGP.ReturnableGPId + "</b>" + "<br />" + "Thank you.";
        ...
        public async Task<IActionResult> OnPost(List<ReturnItemDsc> items, string chkifDeptHeadUn, string chkOtherTo, string chkPamunuFrom, string chkMaduFrom, string chkSinthaFrom, string chkPamunuTo, string chkMaduTo, string chkSinthaTo)
        {
            try
            {
                deptId = Convert.ToInt32(HttpContext.Session.GetString("DepartId"));
                ...
                else if (chkPamunuTo == "false" && chkMaduTo == "false" && chkSinthaTo == "false" && chkOtherTo == "false")
                {
                ...
                else
                {
                    ...
                    {
                        ReturnableGP.FromLocation = 1;
                    }
                    else if (chkMaduFrom == "true")
                    {
                        ReturnableGP.FromLocation = 2;
                    }
                    else if (chkSinthaFrom == "true")
                    {
                        ReturnableGP.FromLocation = 3;
                    }
                    else
                    {
                        ReturnableGP.FromLocation = 0;
                    }


                    if (chkPamunuTo == "true")
                    {
                        ReturnableGP.ToLocation = 1;
                    }
                    else if (chkMaduTo == "true")
                    {
                        ReturnableGP.ToLocation = 2;
                    }
                    else if (chkSinthaTo == "true")
                    {
                        ReturnableGP.ToLocation = 3;
                    }
                    else if(chkOtherTo == "true")
                    {
                        ReturnableGP.ToLocation = 4;
                    }
                    else
                    {
                        ReturnableGP.ToLocation = 0;
                    }


                    ReturnableGP.DepId = Convert.ToInt32(HttpContext.Session.GetString("DepartId"));
                    ReturnableGP.CreateDate = targetLocalTime;
                    ReturnableGP.CreateUser = HttpContext.Session.GetString("FullName");
                    ReturnableGP.UserId = Convert.ToInt32(HttpContext.Session.GetString("UserId"));

                    if (role == 5 || role == 4 || ((chkifDeptHeadUn == "true" && role == 6) || ((deptId == 10 || deptId == 8 || deptId == 9  || deptId == 20 || deptId == 19 || deptId == 22 || deptId == 12) && role == 6)))
                    {
                        ReturnableGP.AShod = "A";
                        if (chkifDeptHeadUn == "true")
                        {
                            ReturnableGP.ChkifDeptHeadUn = true;
                        }
                        else
                        {
                            ReturnableGP.ChkifDeptHeadUn = false;
                        }
                    }
                    else
                    {
                        ReturnableGP.AShod = null;
                    }
                    ...
                    {
                        item.ReGPId = ReturnableGP.ReturnableGPId;
                        _db.ReturnItemDsc.Add(item);
                        Aprvlist = GetDropdownDataApprovalchange();
                        DeptList = GetDropdownDataDepartments();
                        deptId = Convert.ToInt32(HttpContext.Session.GetString("DepartId"));
                        role = Convert.ToInt32(HttpContext.Session.GetString("Roleid"));
                    ...
                    _db.SaveChanges();
                    await _db.ReturnableGP.AddAsync(ReturnableGP);
                    await _db.SaveChangesAsync();

                    _notify.Success("Returnable Gate Pass Successfully Created", 3);
                    //return new JsonResult("Data saved successfully");
                    Aprvlist = GetDropdownDataApprovalchange();
                    DeptList = GetDropdownDataDepartments();

                    EmailSendToMangApprover(ReturnableGP);
                    EmailSendToHodApprover(ReturnableGP);
                    EmailSend(ReturnableGP);
            ...
            {
                cm.Logwrite($"Error in CreateRGPModel OnPost method : {ex.Message}\nInner Exception: {ex.InnerException?.Message}");
                return null;
            }
