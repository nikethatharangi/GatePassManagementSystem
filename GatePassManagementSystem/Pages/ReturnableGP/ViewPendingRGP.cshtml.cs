...
namespace GatePassManagementSystem.Pages.ReturnableGP
{
    public class ViewPendingRGPModel : PageModel
    {
        ...
        public ViewPendingRGPModel(ApplicationDbContext db, INotyfService notyf)
        {
            _db = db;
            cm = new Common();
            _notify = notyf;
        ...
        public IEnumerable<Model.ReturnItemDsc> ReturnItemDscs;

        [BindProperty]
        public Model.ReturnableGP ReturnableGPB { get; set; }

        public Model.ReturnableGP ReturnableGP;
        public Model.ReturnItemDsc ReturnItemDsc;
        ...
        public async Task OnGet()
        {
            try
            {
                ...
                {
                    ReturnableGPs = await _db.ReturnableGP.Where(gp => gp.UserId != Uid && gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.CreateDate.Date == targetLocalTime.Date && gp.AShod == "A" && gp.ASdgm == null && (((gp.DepId == 1 || gp.DepId == 2 || gp.DepId == 3 || gp.DepId == 4 || gp.DepId == 5 || gp.DepId == deptId || gp.DepId == 6 || gp.DepId == 11 || gp.DepId == 13 || gp.DepId == 24 || gp.DepId == 27 || gp.DepId == 28) && gp.ChApprvlId == 0) || (gp.ChApprvlId == 6 && gp.AShod == "A"))).ToListAsync();
                }
                else if (Uid == 31) //Mr. Ruwan
                {
                    ReturnableGPs = await _db.ReturnableGP.Where(gp => gp.ASdgm == null && (((gp.DepId == 8 || gp.DepId == 9 || gp.DepId == 25) && gp.ChApprvlId == 0) || (gp.ChApprvlId == 8 && gp.AShod == "A")) && gp.UserId != Uid && gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.CreateDate.Date == targetLocalTime.Date).ToListAsync();
                }
                else if (Uid == 172) //Mr. Thusitha
                {
                    ReturnableGPs = await _db.ReturnableGP.Where(gp => gp.ASdgm == null && ((gp.DepId == 7 && gp.ChApprvlId == 0) || (gp.ChApprvlId == 7 && gp.AShod == "A")) && gp.UserId != Uid && gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.CreateDate.Date == targetLocalTime.Date).ToListAsync();
                }
                else if (Uid == 145) // Mr. Damith
                {
                    ReturnableGPs = await _db.ReturnableGP.Where(gp => gp.ASdgm == null && ((gp.DepId == deptId || gp.DepId == 14 || gp.DepId == 16 || gp.DepId == 17 || gp.DepId == 18 || gp.DepId == 21 && gp.ChApprvlId == 0) || (gp.ChApprvlId == 26)) && gp.UserId != Uid && gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.CreateDate.Date == targetLocalTime.Date).ToListAsync();
                }
                else if (Uid == 92) // Mr. Vajira
                {
                    ReturnableGPs = await _db.ReturnableGP.Where(gp => gp.AShod == null && (gp.DepId == deptId || gp.DepId == 27) && gp.UserId != Uid && gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.CreateDate.Date == targetLocalTime.Date).ToListAsync();
                }
                else if (Uid == 96) // mr. Wijekoon
                {
                    ReturnableGPs = await _db.ReturnableGP.Where(gp => gp.ASdgm == null && ((gp.DepId == deptId || gp.DepId == 19) && gp.ChApprvlId == 0) && gp.UserId != Uid && gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.CreateDate.Date == targetLocalTime.Date).ToListAsync();
                }
                else if (Uid == 68) // mr. Geethanga
                {
                    ReturnableGPs = await _db.ReturnableGP.Where(gp => gp.ASdgm == null && (gp.DepId == 12 && gp.ChApprvlId == 0) && gp.UserId != Uid && gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.CreateDate.Date == targetLocalTime.Date).ToListAsync();
                }
                else if (Uid == 109) // mrs. Kumudu
                {
                    var query1 = await _db.ReturnableGP // packing
                    ...
                    var query2 = await _db.ReturnableGP  // QA dept
                    ...
                    ReturnableGPs = query1.Union(query2).ToList();

                }
                else if (Uid == 90) // Mr. Rohan
                {
                    var query1 = await _db.ReturnableGP // transport, QMS dept
                    ...
                    var query2 = await _db.ReturnableGP  // stores dept
                ...
                {
                    ReturnableGPs = await _db.ReturnableGP.Where(gp => gp.ASmd == null && ((gp.DepId == deptId && gp.ChApprvlId == 0) || gp.ChApprvlId == 10 && gp.AShod == "A") && gp.UserId != Uid && gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.CreateDate.Date == targetLocalTime.Date).ToListAsync();
                }
                else if (roleId == "3")
                {
                    ReturnableGPs = await _db.ReturnableGP.Where(gp => (gp.DepId == deptId && gp.ChApprvlId == 0) && gp.ASgm == null && gp.ASdgm == "A" && gp.UserId != Uid && gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.CreateDate.Date == targetLocalTime.Date).ToListAsync();
                }
                else if (roleId == "4")
                {
                    ReturnableGPs = await _db.ReturnableGP.Where(gp => (gp.DepId == deptId && gp.ChApprvlId == 0) && gp.ASdgm == null && gp.AShod == "A" && gp.UserId != Uid && gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.CreateDate.Date == targetLocalTime.Date).ToListAsync();
                }
                else if (roleId == "5")
                {
                    ReturnableGPs = await _db.ReturnableGP.Where(gp => gp.DepId == deptId && gp.AShod == null && gp.UserId != Uid && gp.CreateDate.Year == targetLocalTime.Year && gp.CreateDate.Month == targetLocalTime.Month && gp.CreateDate.Date == targetLocalTime.Date).ToListAsync();
                }
        ...
        {
            int uid = _db.ReturnableGP.Where(u => u.Id == Id).Select(u => u.UserId).FirstOrDefault();
            int deptid = _db.ReturnableGP.Where(u => u.Id == Id).Select(u => u.DepId).FirstOrDefault();

            ChngAprl = _db.ReturnableGP.Where(u => u.Id == Id).Select(u => u.ChApprvlId).FirstOrDefault();
            GPNumber = _db.ReturnableGP.Where(u => u.Id == Id).Select(u => u.ReturnableGPId).FirstOrDefault();
            Createuser = _db.ReturnableGP.Where(u => u.Id == Id).Select(u => u.CreateUser).FirstOrDefault();
        ...
        public ActionResult EmailSendSecondApproved(int Id)
        {
            ...
            int Aprchng = _db.ReturnableGP.Where(u => u.Id == Id).Select(u => u.ChApprvlId).FirstOrDefault();
            ...
            {
                int deptid = _db.ReturnableGP.Where(u => u.Id == Id).Select(u => u.ChApprvlId).FirstOrDefault();
                string gmname = _db.Department.Where(u => u.Id == deptid).Select(u => u.Gm).FirstOrDefault();
        ...
        public async Task<IActionResult> OnPostApprove(int Id)
        {
            try
            {
                ...
                if (roleId == "1")
                {
                    await _db.Database.ExecuteSqlRawAsync("UPDATE ReturnableGP SET ASmd = 'A', ASdgm = 'A' , ASmdtime = {1} WHERE Id = {0}", Id, targetLocalTime);
                    _notify.Success("Approved!!", 5);
                    EmailSendSecondApproved(Id);
                }
                else if (roleId == "3")
                {
                    await _db.Database.ExecuteSqlRawAsync("UPDATE ReturnableGP SET ASgm = 'A' , ASgmtime = {1} WHERE Id = {0}", Id, targetLocalTime);
                    _notify.Success("Approved!!", 5);
                }
                else if (roleId == "4")
                {
                    await _db.Database.ExecuteSqlRawAsync("UPDATE ReturnableGP SET ASdgm = 'A' , ASdgmtime = {1} WHERE Id = {0}", Id, targetLocalTime);
                    _notify.Success("Approved!!", 5);
                    EmailSendSecondApproved(Id);
                }
                else if (roleId == "5")
                {
                    if (deptId == 12)
                    {
                        await _db.Database.ExecuteSqlRawAsync("UPDATE ReturnableGP SET AShod = 'A' ,ASdgm = 'A' , AShodtime = {1} WHERE Id = {0}", Id, targetLocalTime);
                        _notify.Success("Approved!!", 5);
                    }
                    else
                    {
                        await _db.Database.ExecuteSqlRawAsync("UPDATE ReturnableGP SET AShod = 'A' , AShodtime = {1} WHERE Id = {0}", Id, targetLocalTime);
                        _notify.Success("Approved!!", 5);
                    }
        ...
        public async Task<IActionResult> OnPostReject(int Id)
        {
            try
            {
                ...
                if (ReturnableGPB.RejctReason == null)
                {
                ...
                else
                {
                    if (roleId == "1")
                    {
                        await _db.Database.ExecuteSqlRawAsync("UPDATE ReturnableGP SET ASmd = 'R' ,RejctReason = {2}, ASmdtime = {1} WHERE Id = {0}", Id, targetLocalTime, ReturnableGPB.RejctReason);
                        _notify.Error("Rejected!!", 5);
                        EmailSendSecondRejected(Id);
                    }
                    else if (roleId == "3")
                    {
                        await _db.Database.ExecuteSqlRawAsync("UPDATE ReturnableGP SET ASgm = 'R' ,RejctReason = {2}, ASgmtime = {1}  WHERE Id = {0}", Id, targetLocalTime, ReturnableGPB.RejctReason);
                        _notify.Error("Rejected!!", 5);
                    }
                    else if (roleId == "4")
                    {
                        await _db.Database.ExecuteSqlRawAsync("UPDATE ReturnableGP SET ASdgm = 'R' ,RejctReason = {2}, ASdgmtime = {1}  WHERE Id = {0}", Id, targetLocalTime, ReturnableGPB.RejctReason);
                        _notify.Error("Rejected!!", 5);
                        EmailSendSecondRejected(Id);
                    }
                    else if (roleId == "5")
                    {
                        await _db.Database.ExecuteSqlRawAsync("UPDATE ReturnableGP SET AShod = 'R' ,RejctReason = {2}, AShodtime = {1}  WHERE Id = {0}", Id, targetLocalTime, ReturnableGPB.RejctReason);
                        _notify.Error("Rejected!!", 5);
